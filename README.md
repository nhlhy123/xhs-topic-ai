# 项目一：小红书选题生成助手 (XHS Topic AI Generator)
...
- 截图文件：产品界面与调试截图)
## 📁 产品设计文档
- 📄 [产品需求文档 (PRD)](./docs/小红书选题生成助手_PRD_v1.0.md)
- 📊 [竞品分析报告](./docs/小红书选题生成助手_竞品分析报告.md)
- 🎨 [高保真原型作品集 (PDF)](./docs/小红书选题生成助手-原型作品集-2026-09-11.pdf)
- 📈 [业务流程图 (Mermaid源码)](./docs/小红书选题生成助手-业务流程图-Mermaid.md)
- ## 🤖 项目二：AI智能客服系统 (B端制造业售后)
- **项目定位**：基于 RAG 知识库与意图识别的 B 端售后客服 MVP。
- **核心能力**：多轮对话槽位提取、置信度不足转人工兜底。
- **查看详情**：[点击进入项目文件夹](./ai-customer-service/README.md)
